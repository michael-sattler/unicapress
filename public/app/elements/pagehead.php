<head>
    ...
    <title><?php echo htmlspecialchars($pagetitle ?? SITE_NAME); ?><?php if (($pagetitle ?? '') !== SITE_NAME): ?> · <?php echo htmlspecialchars(SITE_NAME); ?><?php endif; ?></title>
    <?php if (!empty($pagdescription)): ?>
    <meta name="description" content="<?php echo htmlspecialchars($pagdescription); ?>" />
    <?php endif; ?>
